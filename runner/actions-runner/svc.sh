...
SVC_NAME="actions.runner.TalevskaMaja-python-greetings.Majas-MacBook-Pro-2"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (TalevskaMaja-python-greetings.Majas-MacBook-Pro-2)"
